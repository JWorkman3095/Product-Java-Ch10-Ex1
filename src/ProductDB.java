public class ProductDB {
    ...
    public static Product getProduct(String productCode) {
        ...
        if (productCode.equalsIgnoreCase("java")
        	...
        	Album a1 = new Album();
        	a1.setCode("sgtp");
        	a1.setDescription("Sgt. Peppers");
        	a1.setArtist("The Beatles");
        	a1.setPrice(14.99);
        	p = a1;
        }else if (productCode.equalsIgnoreCase("dtofu")) {
        	Album a2 = new Album();
        	a2.setCode("dtofu");
        	a2.setDescription("The One's For You");
        	a2.setArtist("Dirty Water Revival");
        	a2.setPrice(12.99);
        	p = a2;
        }
        return p;
